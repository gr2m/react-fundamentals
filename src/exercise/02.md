...
- React can be imported from https://unpkg.com/react and
  https://unpkg.com/react-dom into HTML which makes `React.createElement()` and
  `ReactDOM.render()` available.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=epicreact%40martynus.net).
