...
- Set `key` property on each element when returning an array of elements, in
  order for React to match each item with the before/after state when an item
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=epicreact%40martynus.net).
