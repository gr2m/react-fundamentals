...
- `JSX` can be transpiled at runtime by importing
  https://unpkg.com/@babel/standalone and using `<script type="text/babel">`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=epicreact%40martynus.net).
