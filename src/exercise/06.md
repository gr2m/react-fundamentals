...
- [Use `React.useRef` and `ref={myRef}`](https://reactjs.org/docs/hooks-reference.html#useref)
  to store reference to HTML elements.
- Specific to this course: A test can be run in isolation using

  ```
  npx react-scripts test src/__tests__/06.extra-2.js --watchAll=false
  ```
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=epicreact%40martynus.net).
